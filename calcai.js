var first = document.getElementById('course1');
var second = document.getElementById('course2');
var third = document.getElementById('course3');

//main subject 3 input...
...
case "acct":
      ...
      default :
     first.innerHTML = "main subj 1";
     second.innerHTML = "main subj 2";
     third.innerHTML = "main subj 3";
      return false;
      break;
...
//passes for both indigene and non indigene
if (final>=80 && course1 == 'acct')  {
alert("youre good to go");
}


//for indigene only
if (final >=73 && course1 == 'acct' && sog1 == true) {
  "good to go";
}

// error for non indigene
